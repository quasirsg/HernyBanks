  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        ...
        {state.expanded ? <View><Text style={styles.data}>{data}</Text></View> : null}
      </View>
  ...
  return (
    <ScrollView backgroundColor={'white'}>
      ...
      <View style={styles.scroll}>
        ...
        {
          tabState.account ? rendeOptionAccordion(accountOptions) :
            tabState.appUse ? rendeOptionAccordion(appUseOptions) :
              tabState.about ? rendeOptionAccordion(aboutOptions) : null
        }
      </View>
    </ScrollView>
