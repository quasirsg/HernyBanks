...
const appUseOptions = [
  {
    ...
    data:
      " Ni bien ingreses tus datos, el tiempo de verificación de la cuenta bancaria es de 24 horas hábiles.",
  },
  {
    title: "¿Es necesario vincular la cuenta bancaria para hacer un depósito?",
    data:
      "Para hacer un depósito de saldo en tu cuenta no necesitas agregar una cuenta bancaria. Tenés otros métodos de fondeo: podes depositar por Mercado Pago o depositar en efectivo por Rapipago y PagoFacil",
  },
  {
    title: "¿Qué necesito para crear una cuenta?",
    data:
      "Documento de identidad físico (Permanente o temporal). Teléfono celular a la mano. En caso de no contar con cámara en el dispositivo, debes tomar: Una foto en formato .jpg del documento de identidad (sin flash, y con datos legibles). Una selfie tuya en formato .jpg (la capacidad de estas fotos no debe superar los 2MB).",
  },
  {
...
const accountOptions = [
  {
    ...
    data:
      "Aquí deben ir las instrucciones de cómo recuperar la contraseña o un link que nos redirija a la screen en donde se recupera la contraseña.",
  },
  {
    title: "Olvidé mi usuario",
    data:
      "Puedes ingresar con el correo electrónico con el que te registraste en la aplicación. Esta opción es por si podemos habilitar la opción de hacer Log In con username",
  },
  {
    title: "Cambiar mis datos",
    data:
      "Acá podemos poner las instrucciones de cómo ver y modificar los datos que estarán disponibles dentro de la app cuando el usuario esté logueado",
  },
];
...
const aboutOptions = [
  {
    ...
    data:
      "Esta aplicación fue desarrollada por alumnos de HENRY, grupo 5 de la cohorte 05.",
  },
  {
    title: "¿Desarrolladores",
    data:
      "El equipo de desarrollo: Cecilia Cáccamo, Olivert, Camilo Lindarte, Alexis, Gabriela, Juan, Sebastián, Martin Catalá, Carlos Saballe",
  },
];
    ...
    <ScrollView backgroundColor={"white"}>
      <View style={styles.scroll}>
        ...
        <Tabs>
          ...
          <TouchableOpacity
            style={styles.rowII}
            onPress={() => pressedTab("B")}
          >
            <Tab
              title="Uso de la app"
              active={tabState.appUse}
        ...
        {tabState.account
          ? rendeOptionAccordion(accountOptions)
          : tabState.appUse
          ? rendeOptionAccordion(appUseOptions)
          : tabState.about
          ? rendeOptionAccordion(aboutOptions)
          : null}
      </View>
    </ScrollView>
  );
