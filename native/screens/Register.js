      ...
      <View style={styles.container}>
        ...
        <Formik
          ...
          validationSchema={Yup.object({
            ...
            email: Yup.string()
              .email("Introduzca un correo válido por favor")
              .required("Debes completar este campo"),
            dni: Yup.number("Sólo números")
              .required("Debes completar este campo")
              .positive("Verifica el número ingresado")
              .integer("Verifica el número ingresado"),
            password: Yup.string()
            ...
            <View style={styles.form_container}>
              ...
              <Animatable.View animation="bounceInUp" delay={500}>
                ...
                {errors.username ? (
                  ...
                  <Text style={{ fontSize: 10, color: "green" }}>Correcto</Text>
                ) : (
