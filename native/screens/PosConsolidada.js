                ...
                {accounts.length > 0 ? (
                      ...
                      <View key={key}>
                        ...
                        <View style={styles.balanceContainer}>
                          <Text style={styles.textTitle}>
                            Saldo de la cuenta en {cuenta.type}
                          </Text>
                  ...
                  <View>
                    ...
                    <View style={styles.balanceContainer}>
                      ...
                      />
                      <Text style={styles.text_body}>
                        El balance de su cuenta en los ultimos "7 dias" fue de
                        $3.326 a favor.
                      </Text>
                      <TouchableOpacity
                        style={{ alignItems: "flex-end", marginTop: 0 }}
              ...
              <View style={styles.ultimosMovimientosContainer}>
                ...
                transactions[currentAccountIndex].length >= 0 ? (
                  ...
                  <View>
                    ...
                    >
                      <Text style={styles.text_body}>
                        Aún no tienes movimientos en esta cuenta. Cuando
                        realices movimiento en esta cuenta, aquí podrás ver un
                        resumen del mismo.
                      </Text>
                    </View>
                  </View>
